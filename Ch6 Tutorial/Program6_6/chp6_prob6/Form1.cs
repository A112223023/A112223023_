...
namespace chp6_prob6
{
    public partial class Form1 : Form
    {
        ...
        private bool InputIsValid(ref int days, ref decimal fb, ref decimal cb, ref decimal sb, ref decimal mb)
        {
            if (int.TryParse(textBox1.Text, out days) &&
               decimal.TryParse(textBox2.Text, out fb) &&
               decimal.TryParse(textBox2.Text, out sb) &&
               decimal.TryParse(textBox2.Text, out cb) &&
               decimal.TryParse(textBox2.Text, out mb))
            {
                return true;
            }
            else
